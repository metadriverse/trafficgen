...
class initDataset(Dataset):
    ...
    def process(self, data):
        ...
        case_info['cross'],case_info['cross_mask'],case_info['rest'],case_info['rest_mask'] = process_map(data['lane'],data['traffic_light'],  lane_range=self.cfg['map_size'], offest=0)
